use crate::{errors, Contract, Sale, MULTIPLIER};
use near_sdk::{
...
pub struct Subscription {
    pub shares: u128,
    pub last_in_balance: u128,
    pub spent_in_balance_without_shares: u128,
    pub last_out_token_per_share: Vec<[u64; 4]>,
    pub claimed_out_balance: Vec<u128>,
...
pub struct SubscriptionOutput {
    pub remaining_in_balance: U128,
    pub spent_in_balance: U128,
    pub unclaimed_out_balances: Vec<U128>,
    pub claimed_out_balance: Vec<U128>,
    pub shares: U128,
    pub referral_id: Option<AccountId>,
}
...
impl Subscription {
    pub fn touch(&mut self, sale: &Sale) -> Vec<u128> {
        ...
        self.last_out_token_per_share
            ...
            .map(|(last_out_token_per_share, out_token)| {
                let out_token_per_share = U256(out_token.per_share);
                let u256_last_out_token_per_share = U256(*last_out_token_per_share);
    ...
    pub fn new(sale: &Sale, referral_id: Option<AccountId>) -> Self {
        Self {
            ...
            last_out_token_per_share: sale
                .out_tokens
                .iter()
                .map(|out_token| out_token.per_share)
                .collect(),
